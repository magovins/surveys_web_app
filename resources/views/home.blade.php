        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="/questionnaires/search" class="btn btn-secondary">Search Questionnaire</a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <div>
                                <form action="/questionnaires/{{ $questionnaire->id }}/{{ $questionnaire->questions }}" method="post">
                                    @csrf
                                    @method('DELETE')
